...
class ManageLists(commands.Cog, name=i18n("cogs.manage_lists.name")):
    ...
    @commands.command(
        ...
        extras={
            "args": {
                "type": f'{i18n("commands.add.args.type")} ("nouns", "adjectives", "verbs", "adverbs")', # noqa
    ...
    async def add(
        self,
        ctx,
        type: Literal["nouns", "adjectives", "verbs", "adverbs"],
        *words: str
    ):
    ...
    @commands.command(
        ...
        extras={
            "args": {
                "type": f'{i18n("commands.remove.args.type")} ("nouns", "adjectives", "verbs", "adverbs")', # noqa
    ...
    @commands.command(
        ...
        extras={
            "args": {
                "type": f'{i18n("commands.list.args.type")} ("nouns", "adjectives", "verbs", "adverbs")' # noqa
            }
        },
    )
    async def list(
        self, ctx, type: Literal["nouns", "adjectives", "verbs", "adverbs"]
    ):
